...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 27, 2021 at 02:03 PM
...
--
-- Table structure for table `alloted_guide`
--

DROP TABLE IF EXISTS `alloted_guide`;
CREATE TABLE IF NOT EXISTS `alloted_guide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `team_leader_id` int(11) NOT NULL,
  `mentor_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `mentor id` (`mentor_id`),
  KEY `team id` (`team_leader_id`)
...
CREATE TABLE IF NOT EXISTS `mentor` (
  ...
  `live_proj_count` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `mentor` (`mentor_id`, `mentor_name`, `department_id`, `live_proj_count`) VALUES
(1, 'Prof. Sanjeev Dwivedi ', 1, 0),
(2, 'Prof. Swapnil Sonawane', 1, 0),
(3, 'Prof. Snehal Andhare ', 1, 0),
(4, 'Prof. Prita Patil ', 1, 0),
(5, 'Prof. Suvarna Bhat', 1, 0),
(6, 'Prof. Yash Shah', 2, 0),
(7, 'Prof. Bhanu Tekwani', 2, 0),
(8, 'Prof. Mayurkumar Nanda', 4, 0),
(9, 'Prof. Mansi Jha', 4, 0);
...
(5, 'Heart Rate Monitoring System ', 2021, 12, 4, 10, 1, 'Sejal D', '1910276876', 'Nandini', '19108908', 'Priyank', '191065675', 'Utkarsh', '191656665', '', '', '', '', 'It is heart monitoring device made for humans', '19102A0023 Experiment3.pdf', 'DBMS expt 3.pdf', 'DBMS-expt4.pdf', 'DBMS expt  5.pdf', 'https://youtu.be/3xRMUDC74Cw');
...
--
-- Table structure for table `student_guide_form`
--

DROP TABLE IF EXISTS `student_guide_form`;
CREATE TABLE IF NOT EXISTS `student_guide_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `roll_no_4` varchar(10) DEFAULT NULL,
  `domain_id` int(11) NOT NULL,
  `teacher_1_id` int(11) NOT NULL,
  `teacher_2_id` int(11) NOT NULL,
  `teacher_3_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `userid` (`user_id`),
  KEY `department` (`department_id`),
  KEY `domains` (`domain_id`),
  KEY `teacher 1` (`teacher_1_id`),
  KEY `teacher 2` (`teacher_2_id`),
  KEY `teacher 3` (`teacher_3_id`)
...
--
-- Constraints for table `alloted_guide`
--
ALTER TABLE `alloted_guide`
  ADD CONSTRAINT `mentor id` FOREIGN KEY (`mentor_id`) REFERENCES `mentor` (`mentor_id`),
  ADD CONSTRAINT `team id` FOREIGN KEY (`team_leader_id`) REFERENCES `vdummy` (`user_id`);
...
--
-- Constraints for table `student_guide_form`
--
ALTER TABLE `student_guide_form`
  ADD CONSTRAINT `department` FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`),
  ADD CONSTRAINT `domains` FOREIGN KEY (`domain_id`) REFERENCES `domain` (`domain_id`),
  ADD CONSTRAINT `teacher 1` FOREIGN KEY (`teacher_1_id`) REFERENCES `mentor` (`mentor_id`),
  ADD CONSTRAINT `teacher 2` FOREIGN KEY (`teacher_2_id`) REFERENCES `mentor` (`mentor_id`),
  ADD CONSTRAINT `teacher 3` FOREIGN KEY (`teacher_3_id`) REFERENCES `mentor` (`mentor_id`),
  ADD CONSTRAINT `userid` FOREIGN KEY (`user_id`) REFERENCES `vdummy` (`user_id`);
