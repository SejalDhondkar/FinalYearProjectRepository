...
<a href="studentguideform.php"><button type="button" class="btn btn-primary" style="margin-top:10px;margin-left:300px;margin-bottom:10px;">Guide Allotment Form</button></a>
