...
try{
  $stmt = $pdo->prepare('INSERT INTO project
	  (project_title,year_upload,domain_id,mentor_id,user_id,department_id,mem_1_lead,roll_no_1,mem_2,roll_no_2,mem_3,roll_no_3,mem_4,roll_no_4,mem_5,roll_no_5,mem_6,roll_no_6,ssummary,synopsis_path,ppt_path,report_path,publication_path,vid_link)
     VALUES (:title, :year, :domain, :guide, :user_id, :branch, :name1, :roll1, :name2, :roll2, :name3, :roll3, :name4, :roll4, :name5, :roll5, :name6, :roll6, :summary, :m4, :m2, :m1, :m3, :vid)');
      ...
      <main class="flex flex-col space-y-10 px-6 py-5 max-w-6xl mx-auto">
        ...
        <section class="p-6 sm:p-8 flex items-center bg-indigo-700 shadow-md rounded-lg" id="profile">
          <div class="mr-6">
            ...
            <br>
            <span class="text-indigo-50 ">Roll No:</span><span class="text-indigo-50 "><?php if(isset($rowb[0]['roll_no'])){echo  $rowb[0]['roll_no'];}?></span>
            <br>
            ...
            <br>
            <span class="text-indigo-50 ">Div:</span><span class="text-indigo-50 "><?php if(isset($rowb[0]['division'])){echo  $rowb[0]['division'];}?></span>
            <br>
...
<input type="number" name="year" placeholder="Year upload" required>
              ...
              <input type="text" name="a1" placeholder="Roll Numbar" required>
              <span>&nbsp;&nbsp;&nbsp;Members Name and Roll Number :</span>

              <input type="text" name="fielda" placeholder="Student 1" required>
<input type="text" name="a2" placeholder="Roll Numbar" required>
              <input type="text" name="fieldb" placeholder="Student 2" required>
<input type="text" name="a3" placeholder="Roll Numbar"required>
              <input type="text" name="fieldc" placeholder="Student 3">
